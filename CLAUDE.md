...
3. After any code change — execute the mandatory 5-step post-change pipeline:
   ...
   b. Run Sync Gate (Workflow 9) — Code-Wiki Mapping Table + bidirectional verification
...
12. Sync Gate is mandatory after every code change (Workflow 9). Both passes must succeed.
